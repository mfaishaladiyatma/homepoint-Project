...
export default function RiwayatPesanan() {
  ...
  const [riwayatPesanan, setRiwayatPesanan] = useState(false)
      ...
      {riwayatPesanan ?
        <>
          <div className='flex items-center gap-x-5'>
            <button onClick={() => setRiwayatPesanan(!riwayatPesanan)}>
              <AiOutlineArrowLeft className='text-[2rem]' />
            </button>
            <h3 className='text-[30px] font-medium'>Riwayat Pesanan</h3>
          </div>

          <section className='flex gap-x-5  h-[50px]'>
            <button className='flex items-center border-2 border-[#6999B8] rounded-[8px] w-[180px] px-3 justify-between'>
              <p>Semua Status</p>
              <HiChevronDown />
            </button>
            <div className='flex items-center border-2 border-[#6999B8] rounded-[8px] px-3'>
              <input type="text" placeholder='Cari riwayat pesanan' />
              <button>
          ...
          <section className='flex flex-col  w-full h-fit gap-y-5 mt-14'>
            <div className='flex flex-col border-2 border-slate-300 rounded-[8px] min-h-[250px] p-3 gap-y-2'>
              <div className='flex justify-between items-center'>
                ...
                <div className='w-[200px] h-[40px] bg-[#D0FFBF] flex justify-center items-center rounded-[10px] text-[#14B705] font-semibold'>
                  Selesai
                </div>
              </div>

            ...
            <div className='font-Inter bg-cover gap-y-[100px] bg-left-bottom flex flex-col ' style={{ backgroundImage: `url(${backgroundImage})` }} >
                ...
                <div className='flex justify-end py-5 px-14 w-full border-2 border-black'>
                    <div className='container border-2 border-yellow-200 flex justify-end mb-[200px]'>
                        <div className='flex flex-col gap-y-5 items-center border-2 border-blue-700  py-10 px-5 h-fit bg-[#98B6C9] rounded-[16px] max-w-[600px] '>
                            <div className='flex flex-col items-center'>
                                <img src={homePointLogo} alt="" />
                                <h2 className='font-bold text-[40px] text-[#22364A]'>Daftar akun</h2>
                            </div>
                            <div className='flex flex-col gap-y-3 bg-white p-2 justify-between rounded-[10px] w-full'>
                                <p className='px-2'>Nama Lengkap</p>
                                <input className='focus:outline-none focus:border-[#6999B8] focus:ring-2 focus:ring-[#6999B8] caret-[#6999B8] px-2 h-10 rounded-[8px]' placeholder='Nama Lengkap' type="text" />
                            </div>
                            <div className='flex flex-col gap-y-3 bg-white p-2 justify-between rounded-[10px] w-full'>
                                <p className='px-2'>Email/No. Hp</p>
                            ...
                            <div className='flex items-center w-full gap-x-5 border-2 border-black px-3'>
                                <input className='w-[20px] h-[30px]' type="checkbox" />
